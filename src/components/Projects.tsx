      ...
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {projects.map((project) => (
            <article
              key={project.name}
              className="group rounded-2xl border border-zinc-700/60 bg-white/5 p-6 shadow-panel-glow backdrop-blur-md transition-all duration-300 hover:scale-[1.015] hover:border-electric-blue/80 hover:shadow-[0_0_40px_rgba(0,212,255,0.2)]"
            >
